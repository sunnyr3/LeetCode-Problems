# Problem from: https://leetcode.com/problems/implement-stack-using-queues/description/

'''
Implement the following of a stack using queues.
...
2. Depending on your language, queue may not be supported natively. You may simulate a queue by using a list or deque (double-ended queue), as long 
