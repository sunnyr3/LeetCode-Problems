/* Problem from: https://leetcode.com/problems/rank-scores/description/ */
 ...
 * +----+-------+
   ...
   +----+-------+
 *
 * For example, given the above Scores table, your query should generate teh following report (order by highest score):
 * +-------+------+
   | Score | Rank |
   +-------+------+
   | 4.00  | 1    |
